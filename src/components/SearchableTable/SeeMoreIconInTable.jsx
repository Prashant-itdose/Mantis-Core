...
const SeeMoreIconInTable = ({
  ...
  const actions = [
    // {
    //   name: `Actions For ${receiptData?.ProjectID}`,
    //   icon: "fa fa-book",
    // },
    {
      ...
      functionality: () =>
        navigate(`/AmountSubmission`, {
          state: { data: receiptData?.ProjectID },
        }),
    },
    // {
    ...
    //   functionality: () => {
    //     setModal(true);
    //     setVisitID(receiptData?.ProjectID);
    //   },
    // },
    // {
    //   name: "Send Email",
  ...
  const handleSearch = (e) => {
    ...
    setFilterData(filterResponse); // Update filterData with the filtered results
  };
