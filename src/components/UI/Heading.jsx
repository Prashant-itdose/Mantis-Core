...
function Heading({ title, onClick, secondTitle, isBreadcrumb ,multiSelectComponent}) {
    ...
    <div className="card card_background">
      <div className="card-header" onClick={onClick}>
        <h4 className="card-title w-100 d-flex justify-content-between">
          {isBreadcrumb ? (
            <Breadcrumb path={location?.pathname} multiSelectComponent={multiSelectComponent}/>
          ) : (
            <>
