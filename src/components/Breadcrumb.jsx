...
export default function Breadcrumb({ multiSelectComponent }) {
  ...
  return (
    <>
      <div className="pb-2 cursor-pointer font-weight-bold ml-1 mt-2">
        <i className="fa fa-home" aria-hidden="true"></i>
        {/* {location?.state?.data} */}
        {name}
      </div>
      {multiSelectComponent && (
        <div style={{ marginRight: "900px",width:"220px",marginTop:"5px" }}> {multiSelectComponent}</div>
      )}
    </>
  );
}
