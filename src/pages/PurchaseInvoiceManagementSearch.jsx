...
const PurchaseInvoiceManagementSearch = () => {
        ...
        <Heading
          title={
            <span className="font-weight-bold">
              Purchase Invoice Management Search
            </span>
          }
          secondTitle={
            <div className="font-weight-bold">
              <Link to="/PurchaseInvoiceManagement" className="ml-3">
...
export default PurchaseInvoiceManagementSearch;
